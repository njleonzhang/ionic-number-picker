            ...
            return {
                ...
                link: function($scope, element) {
                    ...
                    template: '<div class="row row-center number-picker-style" style="border: #cccccc 1px solid; margin-top: 2px; margin-bottom: 2px; border-radius:4px;padding: 0 !important;">'+
                                ...
                                '<input type="number" class="col-40 col col-center text-center form-control" ng-model="value" ng-blur="inputLostFocus()" style="height:34px;border-radius:0;border-bottom:0; border-top:0; border-right: #cccccc 1px solid; border-left: #cccccc 1px solid; padding: 0">' +
